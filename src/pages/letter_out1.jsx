...
function Letter_out1() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(AppURL.Authority, formDataToSend, {
        headers: {
      ...
      <Navbar/>
        <main className='flex flex-col items-center justify-center'>
          <div className='w-screen text-center m-8'>
            ...
            <h5 className='font-bold text-3xl'> (Authority)</h5>
          </div>
          <div className='bg-[#F0F0F0] w-11/12 h-auto m-8 border-2'>
            <div className='flex flex-row h-16 border-b-2 border-black'>
              <Link to='/letterout1' className='flex justify-center h-full items-center bg-white w-1/4 hover:bg-blue-500 hover:text-white' href='#'>Surat Kuasa</Link>
            ...
            <form className='p-6 lg:p-18 md:p-12 sm:p-10'  encType="multipart/form-data" onSubmit={handleSubmit}>
              ...
              <div className='flex mb-4'>
                <label htmlFor='nomor_surat' className='w-1/3'>No. SK:</label>
